...
public class LibrosDAO implements ItfzLibrosDao {
	...
	public boolean altaLibro(Libro libro){
		...
		try{
			...
			System.err.println("altaLibro:DataAccessException "+dae.getMessage());
			tx.rollback();
			return false;
		}
	...
	public boolean eliminarLibro(String ISBN) {
		...
		try{
			...
			tx.commit();
			if(n==1){
				System.out.println("eliminarLibro(): libro eliminado correctamente");
				return true;
			}
			else{
				System.err.println("eliminarLibro(): El libro NO se ha eliminado correctamente");
				return true;
			}

		}
		catch (DataAccessException dae){
			System.err.println("eliminarLibro():DataAccessException: "+dae.getMessage());
			tx.rollback();
			return false;
		}
	...
	public List<Libro> consultarTodos() {
		...
		try{
			...
			System.err.println("consultarTodos():DataAccessException: "+dae.getMessage());
			return null;
		}
	...
	public Libro consultarISBN(String ISBN) throws LibroNoEncontradoException{
		...
		try{
			...
			if(listaLibros==null ||listaLibros.size()==0){
				...
				throw new LibroNoEncontradoException("No hay ningun libro con isbn:"+ISBN);
			}
			else
			{
			...
			System.err.println("consultarISBN():DataAccessException: "+dae.getMessage());
			return null;
		}
	...
	public List<Libro> consultarTitulo(String titulo) throws LibroNoEncontradoException {
		...
		try{
			...
			List<Libro> listaLibros=(List<Libro>)q.list();
			if(listaLibros==null)
				throw new LibroNoEncontradoException("No hay ningun libro con titulo:"+titulo);
			return listaLibros;
		}
		catch (DataAccessException dae){
			System.err.println("consultarTitulo():DataAccessException: "+dae.getMessage());
			return null;
		}
	...
	public boolean modificarPrecio(String isbn, double precio) {
		...
		try{
			...
			tx.commit();
			if(n==1){
				System.out.println("modificarPrecio(): precio modificado correctamente");
				return true;
			}
			else{
				System.err.println("modificarPrecio(): El precio NO se ha modificado correctamente");
				return true;
			}

		}
		catch (DataAccessException dae){
			System.err.println("modificarPrecio():DataAccessException: "+dae.getMessage());
	...
	public boolean altaAutor(Autor autor) {
		...
		try{
			...
			System.err.println("altaAutor():DataAccessException "+dae.getMessage());
			tx.rollback();
			return false;
		}
	}
	...
	public boolean altaEditorial(Editorial editorial) {
		...
		try{
			...
			System.err.println("altaEditorial():DataAccessException "+dae.getMessage());
			tx.rollback();
			return false;
		}
	}
	...
	public List<Autor> consultarTodosAutores() {
		...
		try{
			...
			System.err.println("consultarTodosAutores():DataAccessException: "+dae.getMessage());
			return null;
		}
	}
	@Override
	public List<Editorial> consultarTodasEditoriales() {
		...
		try{
			...
			System.err.println("consultarTodasEditoriales():DataAccessException: "+dae.getMessage());
			return null;
		}
	}
	@Override
	public boolean eliminarAutor(long id) {
		...
		try{
			...
			tx.commit();
			if(n==1){
				System.out.println("eliminarAutor(): autor eliminado correctamente");
				return true;
			}
			else{
				System.err.println("eliminarAutor(): El autor NO se ha eliminado correctamente");
				return true;
			}

		}
		catch (DataAccessException dae){
			System.err.println("eliminarAutor():DataAccessException: "+dae.getMessage());
			tx.rollback();
			return false;
		}
	...
	public boolean eliminarEditorial(String nif) {
		...
		try{
			...
			tx.commit();
			if(n==1){
				System.out.println("eliminarEditorial(): editorial eliminada correctamente");
				return true;
			}
			else{
				System.err.println("eliminarEditorial(): La editorial NO se ha eliminado correctamente");
				return true;
			}

		}
		catch (DataAccessException dae){
			System.err.println("eliminarEditorial():DataAccessException: "+dae.getMessage());
			tx.rollback();
			return false;
		}
	...
	public List<Autor> consultarNomAutor(String nom) {
		...
		try{
			...
			System.err.println("consultarNomAutor():DataAccessException: "+dae.getMessage());
			return null;
		}
	...
	public List<Autor> consultarNacAutor(String nac) {
		...
		try{
			...
			System.err.println("consultarNacAutor():DataAccessException: "+dae.getMessage());
			return null;
		}
	}
	@Override
	public Editorial consultarNifEditorial(String nif) {
		...
		try{
			...
			System.err.println("consultarNifEditorial():DataAccessException: "+dae.getMessage());
			return null;
		}
	...
	public List<Editorial> consultarNomEditorial(String nom) {
		...
		try{
			...
			System.err.println("consultarNomEditorial():DataAccessException: "+dae.getMessage());
			return null;
		}
	}
	@Override
	public List<String> consultarAutorNacionalidades() {
		...
		try{
			...
			System.err.println("consultarAutorNacionalidades():DataAccessException: "+dae.getMessage());
			return null;
		}
	}
